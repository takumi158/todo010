class TodolistsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @todolist.save
        format.html { redirect_to @todolist, notice: '新しいTODOを登録しました。頑張ってください。' }
  ...
  def update
    respond_to do |format|
      if @todolist.update(todolist_params)
        format.html { redirect_to @todolist, notice: 'TODO内容を更新しました。' }
  ...
  def destroy
    @todolist.destroy
    respond_to do |format|
      format.html { redirect_to todolists_url, notice: 'お疲れ様でした。' }
  ...
  private
    ...
    def todolist_params
      params.require(:todolist).permit(:today, :todo, :memo, :deadline)
    end
end
