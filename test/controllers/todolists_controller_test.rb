...
class TodolistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post todolists_url, params: { todolist: { deadline: @todolist.deadline, memo: @todolist.memo, today: @todolist.today, todo: @todolist.todo } }
    end
  ...
  test "should update todolist" do
    patch todolist_url(@todolist), params: { todolist: { deadline: @todolist.deadline, memo: @todolist.memo, today: @todolist.today, todo: @todolist.todo } }
